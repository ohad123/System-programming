...
public:
    ...
    bool isEmpty(); /* Returns true if the stack is empty; otherwise, it returns false */
    int peek(); /* Returns the top element present in the stack without modifying the stack.
